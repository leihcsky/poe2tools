---
title: "POE2 0.5 Beginners Guide: First Hours Checklist"
category: beginner
date: "2026-05-10"
readMinutes: 8
excerpt: "POE2 0.5 beginners guide with a first-hours checklist: what to do first, how to gear, what to fix when stuck, and a safe Runes of Aldur approach."
image: "/images/guides/poe2-0-5-beginners-guide.svg"
keywords:
...
- Save these references (they reduce guesswork when you hit a wall):
  - Rune combinations tool: [Rune Combos](/tools/rune-combinations)
...
- Open [Rune Database](/db/runes), pick a rune you’re curious about, and read:
...
- Then open [Rune Combos](/tools/rune-combinations) and test a set:
